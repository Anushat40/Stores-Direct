...
public class TS18_TC_66_outflowstock {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("//div[@ng-click=\"OutFlowStockCount(2)\"]")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath(
				"//div[@ng-show=\"OutFlowProductsShow\"]//select[@ng-model=\"RequestStatus\"]//option[@value=\"20\"]"))
				.click();
