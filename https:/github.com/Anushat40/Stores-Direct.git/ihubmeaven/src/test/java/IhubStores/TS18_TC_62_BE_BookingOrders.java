...
public class TS18_TC_62_BE_BookingOrders {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@ng-click=\"BookingOrders('Booking Orders', 'Total')\"]")).click();
		Thread.sleep(2000);
...
//				.sendKeys("31/12/2019");
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@ng-show=\"asstgrid\"]//a[@ng-click=\"toggleGroup(i,i.Orders_Main_ID)\"]")).click();
		Thread.sleep(2000);
