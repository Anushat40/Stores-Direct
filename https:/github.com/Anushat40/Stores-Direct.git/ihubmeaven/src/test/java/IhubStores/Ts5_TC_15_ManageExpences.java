...
public class Ts5_TC_15_ManageExpences {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		/*
		 * create new WebElement checkbox = driver .findElement(By.
		...
		driver.findElement(
				By.xpath("//div[@class=\"content-wrapper\"]//select[@name=\"Status\"]//option[@value=\"10\"]")).click();
		driver.findElement(By.xpath(
				"//div[@class=\"content-wrapper\"]//div[@class=\"input-group input-append date\"]//select[@name=\"MasterName\"]//option[@label=\"Special Discounts\"]"))
				.click();
