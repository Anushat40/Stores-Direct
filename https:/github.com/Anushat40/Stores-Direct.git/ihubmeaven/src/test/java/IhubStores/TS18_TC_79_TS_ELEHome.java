...
public class TS18_TC_79_TS_ELEHome {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("//div[@ng-repeat=\"c in Categorieslist\"][1]")).click();
		// Export Excel
		Thread.sleep(4000);
		//driver.findElement(By.xpath("//div[@ng-show=\"Prductslistgrid\"]//button[@filename=\"filename\"]")).click();
